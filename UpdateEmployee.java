...
public class UpdateEmployee extends JFrame implements ActionListener{
    ...
    UpdateEmployee(String empId) {
        ...
        dcdobb = new JDateChooser();
        dcdobb.setBounds(200, 200, 150, 30);
        add(dcdobb);
        ...
        labelempId1.setBounds(50, 400, 150, 30);
        labelempId1.setFont(new Font("serif", Font.PLAIN, 20));
        add(labelempId1);

        lblempId1 = new JLabel();
        lblempId1.setBounds(200, 400, 150, 30);
        lblempId1.setFont(new Font("serif", Font.PLAIN, 20));
        add(lblempId1);
        ...
        try {
            ...
            while(rs.next()) {
                ...
                lblempId1.setText(rs.getString("empId"));
